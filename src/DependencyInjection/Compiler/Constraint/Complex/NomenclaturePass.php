...
namespace Evrinoma\NomenclatureBundle\DependencyInjection\Compiler\Constraint\Complex;
...
{
    public const NOMENCLATURE_CONSTRAINT = 'evrinoma.nomenclature.constraint.complex.nomenclature';
