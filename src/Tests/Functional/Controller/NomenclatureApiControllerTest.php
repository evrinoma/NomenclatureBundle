 ...
 * @group functional
 */
final class NomenclatureApiControllerTest extends AbstractFunctionalTest
{
    protected string $actionServiceName = 'evrinoma.nomenclature.test.functional.action.nomenclature';
