...
namespace Evrinoma\NomenclatureBundle\Validator;

use Evrinoma\NomenclatureBundle\Entity\Nomenclature\BaseNomenclature;
use Evrinoma\UtilsBundle\Validator\AbstractValidator;
use Symfony\Component\Validator\Validator\ValidatorInterface;

final class NomenclatureValidator extends AbstractValidator
{
    /**
     * @var string|null
     */
    protected static ?string $entityClass = BaseNomenclature::class;
