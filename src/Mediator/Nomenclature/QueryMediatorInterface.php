...
interface QueryMediatorInterface
{
     ...
     * @return mixed
     */
    public function createQuery(NomenclatureApiDtoInterface $dto, QueryBuilderInterface $builder): void;
     ...
     * @return array
     */
    public function getResult(NomenclatureApiDtoInterface $dto, QueryBuilderInterface $builder): array;
}
